...
declare module '#imports' {
  ...
  export { rewriteUrl, RewriteResult } from '../utils/rewriter';
  export { getConfig, updateParam, removeParam, resetDefaults, setEnabled, setGlobalMode, setGlobalRewriteValue, ParamConfig, GlobalMode, ExtensionConfig } from '../utils/storage';
}
