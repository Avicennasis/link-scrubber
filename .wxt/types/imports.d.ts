...
declare global {
  ...
  const getConfig: typeof import('/tmp/zeke/link-scrubber/utils/storage').getConfig
  const injectScript: typeof import('wxt/utils/inject-script').injectScript
  const removeParam: typeof import('/tmp/zeke/link-scrubber/utils/storage').removeParam
  const resetDefaults: typeof import('/tmp/zeke/link-scrubber/utils/storage').resetDefaults
  const rewriteUrl: typeof import('/tmp/zeke/link-scrubber/utils/rewriter').rewriteUrl
  const setEnabled: typeof import('/tmp/zeke/link-scrubber/utils/storage').setEnabled
  const setGlobalMode: typeof import('/tmp/zeke/link-scrubber/utils/storage').setGlobalMode
  const setGlobalRewriteValue: typeof import('/tmp/zeke/link-scrubber/utils/storage').setGlobalRewriteValue
  const storage: typeof import('wxt/utils/storage').storage
  const updateParam: typeof import('/tmp/zeke/link-scrubber/utils/storage').updateParam
...
declare global {
  ...
  // @ts-ignore
  export type { RewriteResult } from '/tmp/zeke/link-scrubber/utils/rewriter'
  import('/tmp/zeke/link-scrubber/utils/rewriter')
  // @ts-ignore
  export type { ParamConfig, GlobalMode, ExtensionConfig } from '/tmp/zeke/link-scrubber/utils/storage'
  import('/tmp/zeke/link-scrubber/utils/storage')
}
